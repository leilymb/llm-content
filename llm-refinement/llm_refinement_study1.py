...
This takes urge_docs.csv (which is the equivalent of the output file 'URGE_new_embeds_{current_datetime}_topic_documents.csv' from clustering with new embddings file ) and outputs recategorized_13_full.csv.
"""
...
cache_dir = "/gpfs/radev/project/huggingface"
...
sample_output.to_csv("/gpfs/radev/project/working_env/recategorized_13_full.csv", index=False)
